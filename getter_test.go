...
func TestGetterCallsGetWithURLEncodedOutputFolder(t *testing.T) {
	...
	_, err := g.Get("github.com/instruqt/hclconfig?ref=7271da1cd14778d3762304954d7061cc753da204", "/mycache", false)
	require.NoError(t, err)

	require.Len(t, *calls, 1)

	require.Equal(t, "/mycache/github.com_instruqt_hclconfig_ref=7271da1cd14778d3762304954d7061cc753da204", (*calls)[0].dest)
}
